...
builder.Services.AddTransient<IFactura, FacturaDAL>();
builder.Services.AddTransient<ITipo, TipoDAL>();
builder.Services.AddTransient<IDetalleFactura, DetalleFacturaDAL>();
